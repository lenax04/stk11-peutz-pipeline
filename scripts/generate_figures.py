...
===========================
Generate publication-quality figures for STK11 variant classification.
...
def main(in_path, out_dir):
    ...
    plt.title("Distribution of ACMG/AMP Variant Classifications for STK11", fontsize=14, fontweight="bold")
    ...
    plt.tight_layout()
    plt.savefig(out_path / "STK11_classification_summary.png", dpi=300)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(out_path / "STK11_variant_spectrum.png", dpi=300)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(out_path / "STK11_gnomad_af_distribution.png", dpi=300)
    plt.close()
    
    print(f"Generated STK11 figures in {out_dir}")
