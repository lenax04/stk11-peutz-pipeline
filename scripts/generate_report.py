...
==========================
Generate HTML summary report for the STK11 variant classification pipeline.
...
<html>
<head>
    <title>MicroSnake Variant Classification Report — STK11</title>
    <style>
...
<body>
    <h1>🧬 MicroSnake Variant Classification Report — STK11 (Peutz-Jeghers)</h1>
